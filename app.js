...
// Complete the exercise in the space below:
isEveryone19OrOlder = devs.every((person) => person > 18);
...
// Complete the exercise in the space below:
totalYearsLived = inventors.reduce((sumYears, inventor) =>sumYears += (inventor.passed - inventor.year), 0);
// Check your work:
...
// Complete the exercise in the space below:
travelMethodCounts = travelMethods.reduce((method, num) =>{
  if(method[num]){
    method[num] +=1;
  }else{
    method[num] = 1;
